...
/**
 * This class encapsulates a time interval value as a delta between two events. Internally, the
 * value is always stored in milliseconds.
 * <p>
 *
 * At the time of creation, the time interval is always specified as a string input. The input
 * contains a numeric part suffixed with a 's', 'm', 'h' or 'd' to signify that the numeric value is
 * in seconds, minutes, hours or days. Note that there should not be any whitespace between the
 * numeric part and the suffix.
 * <p>
 *
 * @author randondiesel
 */
